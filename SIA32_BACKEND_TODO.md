...
- [ ] Add a dedicated non-privileged CLIF stack-allocation instruction so frontends do not name r13 directly. Raw compiler SP read/write support is green; the dedicated IR opcode and its actual ISLE lowering must be introduced together, not as unused helper declarations.
