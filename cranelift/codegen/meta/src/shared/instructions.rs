...
pub(crate) fn define(
    ...
    ig.push(Inst::new("sia_gpr_read", "Read a fixed SIA32 architectural GPR for trap/ABI glue.", &formats.nullary_imm8)
        .operands_in(&[Operand::new("register", &imm.uimm8)])
        .operands_out(&[Operand::new("value", i32_)]).other_side_effects());
    ig.push(Inst::new("sia_gpr_write", "Write a fixed SIA32 architectural GPR for trap/ABI glue.", &formats.binary_imm8)
