...
pub(crate) fn define(
    ...
    ig.push(Inst::new("sia_sread", "Read a SIA32-P system register selected by imm8.", &formats.nullary_imm8)
        ...
        .operands_out(&[Operand::new("value", i32)]).other_side_effects());
    ig.push(Inst::new("sia_swrite", "Write a SIA32-P system register selected by imm8.", &formats.unary_imm8)
        .operands_in(&[Operand::new("value", i32), Operand::new("selector", &imm.uimm8)]).other_side_effects());
    ...
    ig.push(Inst::new("sia_tlbfence_va", "Invalidate SIA32 translation state for a VA.", &formats.unary)
        .operands_in(&[Operand::new("value", i32)]).other_side_effects());
